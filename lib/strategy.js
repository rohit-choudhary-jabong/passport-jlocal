...
function Strategy(options, verify) {
  ...
  this._isAgentCheckoutField = options.isAgentCheckoutField || 'isAgentCheckout';
...
Strategy.prototype.authenticate = function(req, options) {
  ...
  var isAgentCheckout = lookup(req.body, this._isAgentCheckoutField) || 0;
  ...
  isAgentCheckout = (parseInt(isAgentCheckout, 10) === 0) ? false : true;
  ...
  var formData = {
    ...
    "IsOC": isOc,
    "Password": password,
    "IsAgentCheckout" : isAgentCheckout
  };
